 ...
 * @author: blossom
 * @email:
 * @date: 2024/10/18 14:57 Fri
 * @copyright: Copyright (c) 2024 Yxy Inc. All Rights Reserved.
 */
class WorkerInstrumentationTest {
    private lateinit var context: Context
    private val mockUriInput: Pair<String, String> =
        KEY_IMAGE_URI to "android.resource://com.example.first/drawable/android_cupcake"
    ...
    fun blurWorker_doWork_resultSuccessReturnsUri() {
        ...
        runBlocking {
            ...
            assertTrue(
                resultUri?.startsWith("file:///data/user/0/com.example.first/files/blur_filter_outputs/blur-filter-output-")
                    ?: false
            )
        }
    }
